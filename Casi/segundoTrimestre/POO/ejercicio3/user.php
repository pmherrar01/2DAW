...
class User{
    ...
    /**
     * Get the value of conexionDataBase
     */ 
    public function getConexionDataBase()
    {
        return $this->conexionDataBase;
    }

    /**
     * Set the value of conexionDataBase
     *
     * @return  self
     */ 
    public function setConexionDataBase($conexionDataBase)
    {
